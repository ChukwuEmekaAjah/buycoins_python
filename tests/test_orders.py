...
class TestOrdersBuySellMethods(unittest.TestCase):
    ...
    def test_invalid_sell_args(self):
        ...
        """
        try:
            Orders.sell({"price":"QnV5Y29pbnNQcmljZS0zOGIwYTg1Yi1jNjA1LTRhZjAtOWQ1My01ODk1MGVkMjUyYmQ=", "coin_amount":0.02, "cryptocurrency":""})
        except Exception as e:
    ...
    def test_failed_sell_request(self, mock_post):
        ...
        Auth.setup("chuks", "emeka")
        response = Orders.sell({"price":"meat", "coin_amount":0.02, "cryptocurrency":"bitcoin"}, [])
    ...
    def test_failed_buy_request(self, mock_post):
        ...
        Auth.setup("chuks", "emeka")
        response = Orders.buy({"price":"meat", "coin_amount":0.02, "cryptocurrency":"bitcoin"}, [])
